...
function selectPokemon() {
  ...
  // 유효한 인덱스인지 확인
  if (isNaN(pokemon1Index) || isNaN(pokemon2Index) || pokemon1Index < 1 || pokemon1Index > pokemons.length || pokemon2Index < 1 || pokemon2Index > pokemons.length) return alert('값이 올바르지 않습니다.');
